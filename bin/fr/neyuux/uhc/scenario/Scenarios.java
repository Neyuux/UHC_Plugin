...
public enum Scenarios {
    ...
    FAST_SMELTING("FastSmelting", "§7§lFastSmelting", false, false, "", FastSmelting.class, createConfigInv("§7§lFastSmelting", 5, Collections.singletonList(getEntry(0, new ItemsStack(Material.COAL, "§7Rapidité de Cuisson", "§bValeur : §a3 fois plus rapide"))))),
    ...
    BLOOD_DIAMOND("BloodDiamond", "§4§lBlood§b§lDiamond", false, false, "", BloodDiamond.class, createConfigInv("§4§lBlood§b§lDiamond", 5, Collections.singletonList(getEntry(0, new ItemsStack(Material.REDSTONE, "§cDégâts reçus", "§bValeur : §4§l0.5" + Symbols.HEARTH))))),
    ...
    SUPER_HEROES("SuperHeroes", "§c§lSuperHeroes", false, false, "", SuperHeroes.class, createConfigInv("§c§lSuperHeroes", 9, Arrays.asList(getEntry(0, new ItemsStack(Material.IRON_CHESTPLATE, "§7Effet de Résistance", "§bValeur : §aActivé")), getEntry(1, new ItemsStack(new ItemsStack(Material.IRON_SWORD, "§cEffet de Force", "§bValeur : §aActivé").toItemStackwithItemFlag(ItemFlag.HIDE_ATTRIBUTES))), getEntry(0, new ItemsStack(Material.SUGAR, "§bEffet de Rapidité", "§bValeur : §aActivé")), getEntry(3, new ItemsStack(Material.BARRIER, "§dEffet de Double Vie", "§bValeur : §aActivé")), getEntry(4, new ItemsStack(Material.RABBIT_FOOT, "§aEffet de Jump Boost", "§bValeur : §aActivé"))))),
    ...
    NO_CLEANUP("NoCleanUP", "§c§lNoCleanUp", false, false, "", NoCleanUP.class, createConfigInv("§c§lNoCleanUp", 5, Collections.singletonList(getEntry(0, new ItemsStack(Material.APPLE, "§cNombre de Coeurs récupérés", "§bValeur : §a3.0" + Symbols.HEARTH))))),
    ...
    FIRE_ENCHANT_LESS("Fire Enchant Less", "§6§lFire Enchant Less", false, false, "", FireEnchantLess.class, createConfigInv("§6§lFire Enchant Less", 5, Arrays.asList(getEntry(0, new ItemsStack(Material.IRON_SWORD, "§cFire Aspect", "§bValeur : §cDésactivée")), getEntry(1, new ItemsStack(Material.BOW, "§7Flame", "§bValeur : Désactivé"))))),
    ...
    ASSAULT_AND_BATTERY("Assault & Battery", "§c§lAssault&Battery", false, true, "", AssaultAndBattery.class, createConfigInv("§c§lAssault&Battery", 5, Collections.singletonList(getEntry(0, new ItemsStack(Material.ENDER_PORTAL_FRAME, "§7Mode d'assignation automatique", "§bValeur : §aActivée"))))),
