                ...
                switch (args[0].toLowerCase()) {
                    ...
                    case "admin":
                        if (playerUHC.isHost()) {
                            ...
                            StringBuilder message = new StringBuilder("§cÉquipes en vies : \n");
                            for (UHCTeam t : main.getUHCTeamManager().getAliveTeams()) {
                                message.append(t.getTeam().getName()).append(" §8(§7").append(t.getAlivePlayers()).append("§8) §7:");
                                for (PlayerUHC alivePlayer : t.getAlivePlayers()) {
                                    message.append(alivePlayer.getPlayer().getName()).append(" \n");
                                }
                            }
                            message = new StringBuilder("§6Équipes : \n");
