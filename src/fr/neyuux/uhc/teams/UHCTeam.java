...
public class UHCTeam {
    ...
    public void add(Player player) {
        ...
        if (((String)GameConfig.ConfigurableParams.TEAMTYPE.getValue()).startsWith("To")) {
            player.sendMessage(main.getPrefix() + prefix.color.getColor() + "Vous avez rejoint l'Èquipe " + team.getDisplayName() + " !");
            sendMessage(main.getPrefix() + player.getDisplayName() + prefix.color.getColor() + " a rejoint votre Èquipe !");
        }
